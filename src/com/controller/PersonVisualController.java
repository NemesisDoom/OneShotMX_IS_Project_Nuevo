...
public class PersonVisualController {
    ...
    public void reloadPersonTable(){
        ...
        String[] tableProjection = new String[1];
        tableProjection[0] = "*";
        ArrayList<Person> personList = personDAO.selectDataFromDatabase(tableProjection);
    ...
    public void addPersonToTable(Person inPerson){
        ...
        int prsnID = inPerson.getPersonID();
        ...
        rowData.add(String.valueOf(prsnID));
    ...
    private void deletePersonFromTable(int inSelectedIndex){
        PersonTableModel tableModel = (PersonTableModel)personTable.getModel();
        String personStringID = (String)tableModel.getValueAt(inSelectedIndex, 0);
        int personID = Integer.parseInt(personStringID);
