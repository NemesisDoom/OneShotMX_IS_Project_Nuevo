 ...
 * @author Miguel
 */
public class ModifyPersonForm extends javax.swing.JDialog {

    private PersonManagementController personController;
    private ContactInformationController contactInfoController;
    private Person modifyingPerson;
    
    /** Creates new form PersonManagement */
    public ModifyPersonForm() {
        initComponents();
        contactInfoController = new ContactInformationController();
        personController = PersonManagementController.getInstance();        
    }

    public ModifyPersonForm(Person inModifyingPerson){
        this();
        modifyingPerson = inModifyingPerson;
    }
    
    public void setPersonName(String firstName,String lastName){
        txt_personFirstName.setText(firstName);
        txt_personLastName.setText(lastName);
    }
    
    public void setPersonAddresses(String address,String emailAddress){
        this.txt_personAddress.setText(address);
        txt_personEmailAddress.setText(emailAddress);
    }
    
    public void setPersonCellphones(String cellphone,String extraCellphone){
        txt_personCellphoneNumber.setText(cellphone);
        txt_personExtraCellphoneNumber.setText(extraCellphone);
    }
    
    public void setPersonHomephoneNumbers(String homePhoneNumber,String extraHomePhoneNumber){
        this.txt_personTelephoneNumber.setText(homePhoneNumber);
        txt_personExtraTelephoneNumber.setText(extraHomePhoneNumber);
    }
    
    public void setRegistryDate(String inRegistryDate){
        txt_registrationDate.setText(inRegistryDate);
    }
    ...
    private void initComponents() {
        ...
        txt_personFirstName.setEditable(false);

        txt_personLastName.setEditable(false);
        ...
        bttn_modify.setText("Modificar Datos");
...
// TODO add your handling code here:
    String emailAddress = txt_personEmailAddress.getText();
    String address = txt_personAddress.getText();
    String cellphoneNumber = txt_personCellphoneNumber.getText();
    String extraCellphoneNumber = txt_personExtraCellphoneNumber.getText();
    String homephoneNumber = txt_personTelephoneNumber.getText();
    String extraHomephoneNumber = txt_personExtraTelephoneNumber.getText();
    ContactInformation newContactInfo = contactInfoController.createContactInformation(
            address,
            emailAddress,
            homephoneNumber,
            cellphoneNumber,
            extraCellphoneNumber,
            extraHomephoneNumber
            );
    
    String personFirstName = modifyingPerson.getFirstName();
    String personLastName = modifyingPerson.getLastName();
    Date registryDate = modifyingPerson.getRegistrationDate();
    
    Person modifiedPerson = personController.createPerson(
            personFirstName, 
            personLastName, 
            newContactInfo, 
            registryDate
    ...
    personController.modifyPerson(modifyingPerson,modifiedPerson,this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyPersonForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ModifyPersonForm().setVisible(true);
            }
        });
    }
